...
\newcommand{\supp}[1]{\text{supp}(#1)} % Support
...
\newcommand{\weakstarto}{\stackrel{\mathclap{*}}{\rightarpoonup}} % Weak-* convergence

% Quantifiers with space
...
\newcommand{\Bin}{\operatorname{Binomial}} % Binomial dist
\newcommand{\Be}{\operatorname{Bernoulli}} % Bernoulli dist
\newcommand{\Po}{\operatorname{Poisson}} % Poisson dist
\newcommand{\Pa}{\operatorname{Pascal}} % Pascal dist
...
\newcommand{\iidsim}{\stackrel{\mathclap{iid}}{\sim}} % i.i.d. distribution
